...
public class _Super_User extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    ...
    public function _Super_User()
    {
        ...
        model_internal::_changeWatcherArray.push(mx.binding.utils.ChangeWatcher.watch(this, "fullname", model_internal::setterListenerFullname));
    ...
    model_internal function setterListenerFullname(value:flash.events.Event):void
    {
        _model.invalidateDependentOnFullname();
    }
    ...
    model_internal function calculateIsValid():Boolean
    {
        ...
        if (!_model.fullnameIsValid)
        {
            propertyValidity = false;
            com.adobe.fiber.util.FiberUtils.arrayAdd(validationFailureMessages, _model.model_internal::_fullnameValidationFailureMessages);
        }
    ...
    model_internal var _doValidationCacheOfFullname : Array = null;
    model_internal var _doValidationLastValOfFullname : String;

    model_internal function _doValidationForFullname(valueIn:Object):Array
    {
        var value : String = valueIn as String;

        if (model_internal::_doValidationCacheOfFullname != null && model_internal::_doValidationLastValOfFullname == value)
           return model_internal::_doValidationCacheOfFullname ;

        _model.model_internal::_fullnameIsValidCacheInitialized = true;
        var validationFailures:Array = new Array();
        var errorMessage:String;
        var failure:Boolean;

        var valRes:ValidationResult;
        if (_model.isFullnameAvailable && _internal_fullname == null)
        {
            validationFailures.push(new ValidationResult(true, "", "", "fullname is required"));
        }

        model_internal::_doValidationCacheOfFullname = validationFailures;
        model_internal::_doValidationLastValOfFullname = value;
