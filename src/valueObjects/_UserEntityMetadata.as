...
internal class _UserEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    ...
    model_internal static var allProperties:Array = new Array("id", "name", "fullname", "email", "password", "created_at", "updated_at", "type");
    model_internal static var allAssociationProperties:Array = new Array();
    model_internal static var allRequiredProperties:Array = new Array("id", "name", "fullname", "email", "password", "created_at", "updated_at", "type");
    model_internal static var allAlwaysAvailableProperties:Array = new Array("id", "name", "fullname", "email", "password", "created_at", "updated_at", "type");
    model_internal static var guardedProperties:Array = new Array();
    model_internal static var dataProperties:Array = new Array("id", "name", "fullname", "email", "password", "created_at", "updated_at", "type");
    ...
    model_internal var _fullnameIsValid:Boolean;
    model_internal var _fullnameValidator:com.adobe.fiber.styles.StyleValidator;
    model_internal var _fullnameIsValidCacheInitialized:Boolean = false;
    model_internal var _fullnameValidationFailureMessages:Array;
    ...
    public function _UserEntityMetadata(value : _Super_User)
    {
        ...
        model_internal::_fullnameValidator = new StyleValidator(model_internal::_instance.model_internal::_doValidationForFullname);
        model_internal::_fullnameValidator.required = true;
        model_internal::_fullnameValidator.requiredFieldError = "fullname is required";
        //model_internal::_fullnameValidator.source = model_internal::_instance;
        //model_internal::_fullnameValidator.property = "fullname";
    ...
    public function invalidateDependentOnFullname():void
    {
        if (model_internal::_fullnameIsValidCacheInitialized )
        {
            model_internal::_instance.model_internal::_doValidationCacheOfFullname = null;
            model_internal::calculateFullnameIsValid();
        }
    }
    ...
    public function get fullnameValidator() : StyleValidator
    {
        return model_internal::_fullnameValidator;
    }

    model_internal function set _fullnameIsValid_der(value:Boolean):void 
    {
        var oldValue:Boolean = model_internal::_fullnameIsValid;         
        if (oldValue !== value)
        {
            model_internal::_fullnameIsValid = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "fullnameIsValid", oldValue, value));
        }                             
    }

    [Bindable(event="propertyChange")]
    public function get fullnameIsValid():Boolean
    {
        if (!model_internal::_fullnameIsValidCacheInitialized)
        {
            model_internal::calculateFullnameIsValid();
        ...
        return model_internal::_fullnameIsValid;
    }

    model_internal function calculateFullnameIsValid():void
    {
        var valRes:ValidationResultEvent = model_internal::_fullnameValidator.validate(model_internal::_instance.fullname)
        model_internal::_fullnameIsValid_der = (valRes.results == null);
        model_internal::_fullnameIsValidCacheInitialized = true;
        if (valRes.results == null)
             model_internal::fullnameValidationFailureMessages_der = emptyArray;
        else
        {
            var _valFailures:Array = new Array();
            for (var a:int = 0 ; a<valRes.results.length ; a++)
            ...
            model_internal::fullnameValidationFailureMessages_der = _valFailures;
        }
    }

    [Bindable(event="propertyChange")]
    public function get fullnameValidationFailureMessages():Array
    {
        if (model_internal::_fullnameValidationFailureMessages == null)
            model_internal::calculateFullnameIsValid();

        return _fullnameValidationFailureMessages;
    }

    model_internal function set fullnameValidationFailureMessages_der(value:Array) : void
    {
        var oldValue:Array = model_internal::_fullnameValidationFailureMessages;
        ...
        if (needUpdate)
        {
            model_internal::_fullnameValidationFailureMessages = value;   
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "fullnameValidationFailureMessages", oldValue, value));
            // Only execute calculateIsValid if it has been called before, to update the validationFailureMessages for
            // the entire entity.
            if (model_internal::_instance.model_internal::_cacheInitialized_isValid)
            {
     ...
     */  
     override public function getPropertyValidationFailureMessages(propertyName:String):Array
     {
         switch(propertyName)
         {
            ...
            case("fullname"):
            {
                return fullnameValidationFailureMessages;
            }
            case("email"):
            {
